        ...
        <div className="bg-gray-800/80 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <div className=" rounded-xl">
              ...
              <p className="text-gray-400 text-sm">to continue to StreamHub</p>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link to="/signup" className="text-red-400 hover:text-red-300 font-medium transition-colors duration-200 underline">
                Sign up
              </Link>
            </p>
          </div>
